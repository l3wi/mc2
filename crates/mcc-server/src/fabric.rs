...
use mcc_api::agent::{FabricAllow, FabricDesired, FabricExpose};
use mcc_api::{fabric_fqdn, ServiceSpec};
use mcc_store::InstanceRecord;
...
mod tests {
    use super::*;
    use mcc_api::{AllowSpec, ExposeSpec};
    ...
    fn fabric_plan_marks_local_backend() {
        ...
        assert_eq!(plan.allows[0].fqdn, "db.shop.svc.mcc");
